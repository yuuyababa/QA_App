...
import kotlinx.android.synthetic.main.activity_quenstion_send.*


import java.io.ByteArrayOutputStream
import java.util.HashMap

class QuenstionSendActivity : AppCompatActivity(), View.OnClickListener, DatabaseReference.CompletionListener {
    companion object {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_quenstion_send)
